...
const Navbar = () => {
  ...
  const menuItems = <>
    ...
    <li>
      <a
        href="/"
        class="inline-flex items-center w-full lg:w-28 justify-center h-12 lg:h-9 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-purple-600 hover:bg-purple-700 focus:shadow-outline focus:outline-none"
        aria-label="Sign up"
        title="Sign up"
      >
        Sign up
